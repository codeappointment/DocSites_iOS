...
extension View {
    func gradientBackground(startColor: Color = Color.black,  endColor: Color = Color(red: 0.0, green: 0.5, blue: 1.0), startPoint: UnitPoint = .bottomLeading, endPoint: UnitPoint = .topTrailing) -> some View {
